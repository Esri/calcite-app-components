...
(function () {
    ...
    var loadToggles = function () { return __awaiter(_this, void 0, void 0, function () {
        var root, response, text, template, nav;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    nav = document.querySelector("nav") || document.querySelector("calcite-demo-nav");
    ...
    var components = null;
    var excludedComponents = ["calcite-demo-nav", "calcite-button"];
