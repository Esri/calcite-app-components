...
class CalciteBlockSection {
    ...
    render() {
        ...
        const dir = __chunk_5.getElementDir(el);
        ...
        const headerNode = (__chunk_1.h("calcite-action", { "aria-label": toggleLabel, onClick: this.onHeaderClick, text: this.text, "text-enabled": true, compact: true }, __chunk_1.h(__chunk_4.CalciteIcon, { size: "16", path: arrowIcon })));
        return (__chunk_1.h(__chunk_1.Host, { "aria-expanded": open ? "true" : "false" }, headerNode, __chunk_1.h("div", { class: CSS.content, hidden: !open }, __chunk_1.h("slot", null))));
    }
