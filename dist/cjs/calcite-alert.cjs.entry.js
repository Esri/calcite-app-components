...
class CalciteAlert {
    constructor(hostRef) {
        ...
        this.iconDefaults = {
            green: __chunk_2.checkCircle24F,
            yellow: __chunk_2.exclamationMarkTriangle24F,
            red: __chunk_2.exclamationMarkTriangle24F,
            blue: __chunk_2.lightbulb24F
        };
    ...
    render() {
        const closeButton = (__chunk_1.h("button", { class: "alert-close", "aria-label": "close", onClick: () => this.closeCalciteAlert() }, __chunk_1.h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "32", width: "32", viewBox: "0 0 32 32" }, __chunk_1.h("path", { d: __chunk_2.x32 }))));
...
__chunk_7.AlertInterface.injectProps(CalciteAlert, ["currentAlert", "queueLength"]);
