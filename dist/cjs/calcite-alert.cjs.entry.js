...
const AlertInterface = require('./AlertInterface-22968f84.js');
...
const CalciteAlert = class {
    ...
    render() {
        ...
        return (core.h(core.Host, { theme: this.theme, active: !!this.active, duration: this.duration }, icon, core.h("div", { class: "alert-content" }, core.h("slot", { name: "alert-title" }), core.h("slot", { name: "alert-message" }), core.h("slot", { name: "alert-link" })), count, close, progress));
    }
...
AlertInterface.AlertInterface.injectProps(CalciteAlert, ["currentAlert", "queueLength"]);
