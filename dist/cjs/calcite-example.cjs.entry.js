...
class CalciteExample {
    constructor(hostRef) {
        ...
        this.calciteExampleEvent = __chunk_1.createEvent(this, "calciteExampleEvent", 7);
    }
    handleSomeProp() {
        // ...
    }
    ...
    // --------------------------------------------------------------------------
    render() {
        return (__chunk_1.h(__chunk_1.Host, null, __chunk_1.h("div", { class: CSS.foo }, this.someProp ? this.textMyString : null)));
    }
