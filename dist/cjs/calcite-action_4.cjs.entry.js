...
class CalciteAction {
    ...
    render() {
        ...
        const iconContainerNode = (__chunk_1.h("div", { key: "icon-container", "aria-hidden": "true", class: CSS.iconContainer }, __chunk_1.h("slot", null)));
        const textContainerNode = textEnabled ? (__chunk_1.h("div", { key: "text-container", class: CSS.textContainer }, text)) : null;
        const labelFallback = label || text;
        const rtl = __chunk_4.getElementDir(el) === "rtl";
        const buttonClasses = {
            [CSS.compact]: compact,
            [CSS_UTILITY.rtl]: rtl
        };
        return (__chunk_1.h(__chunk_1.Host, null, __chunk_1.h("button", { class: __chunk_5.classnames(CSS.button, buttonClasses), title: labelFallback, "aria-label": labelFallback }, iconContainerNode, textContainerNode)));
    }
...
class CalciteActionBar {
    ...
    renderExpandToggle() {
        ...
        const icons = [__chunk_2.chevronsLeft16, __chunk_2.chevronsRight16];
        if (rtl) {
            icons.reverse();
        }
        ...
        return expand ? (__chunk_1.h("calcite-action", { onClick: this.toggleExpand, textEnabled: expanded, text: expandText }, __chunk_1.h(__chunk_3.CalciteIcon, { size: "16", path: expanded ? expandIcon : collapseIcon }))) : null;
    }
    renderBottomActionGroup() {
        const expandToggleNode = this.renderExpandToggle();
        return this.el.querySelector("[slot=bottom-actions]") || expandToggleNode ? (__chunk_1.h("calcite-action-group", { class: CSS$1.actionGroupBottom }, __chunk_1.h("div", { class: CSS$1.actionGroupBottomContainer }, __chunk_1.h("slot", { name: "bottom-actions" })), expandToggleNode)) : null;
    }
    render() {
        return (__chunk_1.h(__chunk_1.Host, null, __chunk_1.h("slot", null), this.renderBottomActionGroup()));
    }
    // --------------------------------------------------------------------------
    //
    //  Private Methods
...
class CalciteActionPad {
    ...
    render() {
        ...
        return (__chunk_1.h(__chunk_1.Host, { style: style }, __chunk_1.h("slot", null)));
    }
    // --------------------------------------------------------------------------
    //
    //  Private Methods
