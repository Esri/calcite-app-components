...
const CalciteAction = class {
    ...
    render() {
        ...
        return (core.h(core.Host, null, core.h("button", { class: index$1.classnames(CSS.button, buttonClasses), title: labelFallback, "aria-label": labelFallback, disabled: disabled }, iconContainerNode, textContainerNode)));
    }
...
const CalciteActionBar = class {
    ...
    renderExpandToggle() {
        ...
        const icons = [index.chevronsLeft16, index.chevronsRight16];
        if (rtl) {
            icons.reverse();
        }
