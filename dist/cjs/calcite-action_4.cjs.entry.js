...
const CalciteAction = class {
    ...
    render() {
        ...
        return (core.h(core.Host, null, core.h("button", { class: index$1.classnames(CSS.button, buttonClasses), title: labelFallback, "aria-label": labelFallback }, iconContainerNode, textContainerNode)));
    }
