...
class CalciteActionBar {
    ...
    renderExpandToggle() {
        ...
        const rtl = __chunk_5.getElementDir(el) === "rtl";
        ...
        return expand ? (__chunk_1.h("calcite-action", { onClick: this.toggleExpand, textEnabled: expanded, text: expandText }, __chunk_1.h(__chunk_4.CalciteIcon, { size: "16", path: expanded ? expandIcon : collapseIcon }))) : null;
    }
    renderBottomActionGroup() {
        const expandToggleNode = this.renderExpandToggle();
        return this.el.querySelector("[slot=bottom-actions]") || expandToggleNode ? (__chunk_1.h("calcite-action-group", { class: CSS$1.actionGroupBottom }, __chunk_1.h("slot", { name: "bottom-actions" }), expandToggleNode)) : null;
    }
    render() {
