...
class CalciteShellPanel {
    ...
    render() {
        const { layout } = this;
        const contentNode = (__chunk_1.h("div", { class: CSS$1.content }, __chunk_1.h("slot", null)));
