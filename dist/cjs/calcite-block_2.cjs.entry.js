...
const CalciteBlock = class {
    ...
    render() {
        ...
        const headerNode = (core.h("div", { class: CSS.headerContainer }, collapsible ? (core.h("button", { "aria-label": toggleLabel, class: CSS.toggle, onClick: this.onHeaderClick, title: toggleLabel }, headerContent, core.h(CalciteIcon.CalciteIcon, { size: "16", path: open ? index.chevronUp16 : index.chevronDown16, svgAttributes: { class: CSS.toggleIcon } }))) : (headerContent)));
...
const CalciteBlockSection = class {
    ...
    render() {
        ...
        const arrowIcon = open ? index.caretDown16F : dir === "rtl" ? index.caretLeft16F : index.caretRight16F;
        const toggleLabel = open ? textCollapse : textExpand;
