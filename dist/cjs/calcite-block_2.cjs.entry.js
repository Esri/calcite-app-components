...
class CalciteBlockSection {
    constructor(hostRef) {
        ...
        this.calciteBlockSectionToggle = __chunk_1.createEvent(this, "calciteBlockSectionToggle", 7);
    }
    // --------------------------------------------------------------------------
    //
    //  Render Methods
    ...
    render() {
        ...
        const arrowIcon = open ? __chunk_2.caretDown16F : dir === "rtl" ? __chunk_2.caretLeft16F : __chunk_2.caretRight16F;
        const toggleLabel = open ? textCollapse : textExpand;
        const headerNode = (__chunk_1.h("calcite-action", { "aria-label": toggleLabel, onClick: this.onHeaderClick, text: this.text, "text-enabled": true, compact: true }, __chunk_1.h(__chunk_3.CalciteIcon, { size: "16", path: arrowIcon })));
        return (__chunk_1.h(__chunk_1.Host, { "aria-expanded": open ? "true" : "false" }, headerNode, __chunk_1.h("div", { class: CSS$1.content, hidden: !open }, __chunk_1.h("slot", null))));
    }
    get el() { return __chunk_1.getElement(this); }
