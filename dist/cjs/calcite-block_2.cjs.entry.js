...
const CalciteBlock = class {
    constructor(hostRef) {
        ...
        this.calciteBlockToggle = core.createEvent(this, "calciteBlockToggle", 7);
    }
    // --------------------------------------------------------------------------
    //
    //  Render Methods
    ...
    render() {
        ...
        const headerContent = (core.h("header", { class: CSS.header }, core.h("div", { class: CSS.title }, core.h("h3", { class: CSS.heading }, heading), summary ? core.h("div", { class: CSS.summary }, summary) : null), core.h("slot", { name: CONTROL_SLOT_NAME })));
        const headerNode = (core.h("div", { class: CSS.headerContainer }, collapsible ? (core.h("button", { "aria-label": toggleLabel, class: CSS.toggle, onClick: this.onHeaderClick, title: toggleLabel }, headerContent, core.h(CalciteIcon.CalciteIcon, { size: "16", path: open ? CalciteIcon.chevronUp16 : CalciteIcon.chevronDown16, svgAttributes: { class: CSS.toggleIcon } }))) : (headerContent)));
        const hasContent = !!Array.from(el.children).some((child) => child.slot !== CONTROL_SLOT_NAME);
        return (core.h(core.Host, { "aria-expanded": collapsible ? (open ? "true" : "false") : null }, core.h("article", null, headerNode, core.h("div", { class: CSS.content, hidden: !hasContent || !open }, core.h("slot", null)))));
    }
...
const CalciteBlockSection = class {
    constructor(hostRef) {
        ...
        this.calciteBlockSectionToggle = core.createEvent(this, "calciteBlockSectionToggle", 7);
    }
    // --------------------------------------------------------------------------
    //
    //  Render Methods
    ...
    render() {
        ...
        const arrowIcon = open ? CalciteIcon.caretDown16F : dir === "rtl" ? CalciteIcon.caretLeft16F : CalciteIcon.caretRight16F;
        const toggleLabel = open ? textCollapse : textExpand;
        const headerNode = (core.h("calcite-action", { "aria-label": toggleLabel, onClick: this.onHeaderClick, text: this.text, "text-enabled": true, compact: true }, core.h(CalciteIcon.CalciteIcon, { size: "16", path: arrowIcon })));
        return (core.h(core.Host, { "aria-expanded": open ? "true" : "false" }, headerNode, core.h("div", { class: CSS$1.content, hidden: !open }, core.h("slot", null))));
    }
    get el() { return core.getElement(this); }
