...
class CalciteFloatingPanel {
    ...
    render() {
        ...
        return (__chunk_1.h(__chunk_1.Host, { style: style }, __chunk_1.h("header", { class: CSS.header }, __chunk_1.h("h3", { class: CSS.heading }, this.heading), __chunk_1.h("calcite-action", { onClick: this.hidePanel }, __chunk_1.h(__chunk_4.CalciteIcon, { size: "16", path: __chunk_2.x16 }))), __chunk_1.h("div", { class: CSS.content }, __chunk_1.h("slot", null))));
    }
    // --------------------------------------------------------------------------
    //
    //  Private Methods
