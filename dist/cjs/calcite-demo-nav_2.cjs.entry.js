...
const NAV_ITEMS = [
    {
        id: "home",
        path: "",
        content: __chunk_1.h(__chunk_3.CalciteIcon, { size: "16", path: __chunk_2.home16, title: "Home" })
    },
    {
        id: "calcite-action",
...
class CalciteDemoNav {
    ...
    renderNavItem(item) {
        ...
        return (__chunk_1.h("li", null, __chunk_1.h("a", { class: id === pageId ? CSS.isActive : null, href: `${root}${path}` }, content)));
    }
    render() {
        return (__chunk_1.h(__chunk_1.Host, null, __chunk_1.h("ul", null, NAV_ITEMS.map((item) => this.renderNavItem(item)))));
    }
