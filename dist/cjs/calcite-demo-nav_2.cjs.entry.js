...
const NAV_ITEMS = [
    {
        id: "home",
        path: "",
        content: core.h(CalciteIcon.CalciteIcon, { size: "16", path: CalciteIcon.home16, title: "Home" })
    },
    {
        id: "calcite-action",
...
const CalciteDemoNav = class {
    ...
    renderNavItem(item) {
        ...
        return (core.h("li", null, core.h("a", { class: id === pageId ? CSS.isActive : null, href: `${root}${path}` }, content)));
    }
    render() {
        return (core.h(core.Host, null, core.h("ul", null, NAV_ITEMS.map((item) => this.renderNavItem(item)))));
    }
...
const CalciteExample = class {
    constructor(hostRef) {
        ...
        this.calciteExampleEvent = core.createEvent(this, "calciteExampleEvent", 7);
    }
    handleSomeProp() {
        // ...
    }
    ...
    // --------------------------------------------------------------------------
    render() {
        return (core.h(core.Host, null, core.h("div", { class: CSS$1.foo }, this.someProp ? this.textMyString : null)));
    }
...
exports.calcite_demo_nav = CalciteDemoNav;
