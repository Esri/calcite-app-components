...
const CalciteShell = class {
    ...
    renderContent() {
        return (core.h("div", { class: CSS.content }, core.h("slot", null)));
    }
    renderFooter() {
        const hasFooter = !!this.el.querySelector("[slot=shell-footer]");
        return hasFooter ? (core.h("div", { class: CSS.footer }, core.h("slot", { name: "shell-footer" }))) : null;
    }
    renderMain() {
        return (core.h("div", { class: CSS.main }, core.h("slot", { name: "primary-panel" }), this.renderContent(), core.h("slot", { name: "contextual-panel" }), core.h("slot", { name: "tip-manager" })));
    }
    render() {
...
const CalciteShellFloatingPanel = class {
    constructor(hostRef) {
        ...
        this.calciteShellFloatingPanelClose = core.createEvent(this, "calciteShellFloatingPanelClose", 7);
    }
    // --------------------------------------------------------------------------
    //
    //  Private Methods
    ...
    render() {
        ...
        return (core.h(core.Host, null, core.h("div", { class: index.classnames(CSS$1.container, {
                [resources.CSS_UTILITY.rtl]: rtl,
                [CSS$1.containerLeading]: layout === "leading",
                [CSS$1.containerTrailing]: layout === "trailing"
            }), style: style }, core.h("header", { class: CSS$1.header }, core.h("h3", { class: CSS$1.heading }, this.heading), core.h("calcite-action", { onClick: this.hidePanel }, core.h(CalciteIcon.CalciteIcon, { size: "16", path: CalciteIcon.x16 }))), core.h("div", { class: CSS$1.content }, core.h("slot", null)))));
    }
    get el() { return core.getElement(this); }
...
const CalciteShellPanel = class {
    ...
    render() {
        ...
        return (core.h(core.Host, null, mainNodes, core.h("slot", { name: "shell-floating-panel" }), core.h("slot", { name: "action-pad" })));
    }
...
exports.calcite_shell_floating_panel = CalciteShellFloatingPanel;
