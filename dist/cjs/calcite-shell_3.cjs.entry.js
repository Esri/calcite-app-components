...
const CalciteShellFloatingPanel = class {
    ...
    render() {
        ...
        return (core.h(core.Host, { style: style }, core.h("header", { class: CSS$1.header }, core.h("h3", { class: CSS$1.heading }, this.heading), core.h("calcite-action", { onClick: this.hidePanel }, core.h(CalciteIcon.CalciteIcon, { size: "16", path: CalciteIcon.x16 }))), core.h("div", { class: CSS$1.content }, core.h("slot", null))));
    }
    get el() { return core.getElement(this); }
