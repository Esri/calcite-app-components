...
class CalciteTipManager {
    ...
    render() {
        ...
        return (__chunk_1.h(__chunk_1.Host, null, __chunk_1.h("header", { class: CSS$1.header }, __chunk_1.h("h2", { class: CSS$1.heading }, this.groupTitle), __chunk_1.h("calcite-action", { onClick: this.hideTipManager, class: CSS$1.close }, __chunk_1.h(__chunk_3.CalciteIcon, { size: "16", path: __chunk_2.x16 }))), __chunk_1.h("div", { class: __chunk_5.classnames(CSS$1.tipContainer, this.direction), key: this.selectedIndex }, __chunk_1.h("slot", null)), __chunk_1.h("footer", { class: CSS$1.pagination }, __chunk_1.h("calcite-action", { onClick: this.previousClicked, class: CSS$1.pagePrevious }, __chunk_1.h(__chunk_3.CalciteIcon, { size: "16", path: __chunk_2.chevronLeft16 })), __chunk_1.h("span", { class: CSS$1.pagePosition }, `${this.textPaginationLabel} ${this.selectedIndex + 1}/${this.total}`), __chunk_1.h("calcite-action", { onClick: this.nextClicked, class: CSS$1.pageNext }, __chunk_1.h(__chunk_3.CalciteIcon, { size: "16", path: __chunk_2.chevronRight16 })))));
    }
    get el() { return __chunk_1.getElement(this); }
