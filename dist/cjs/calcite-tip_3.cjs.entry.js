...
const CalciteTip = class {
    constructor(hostRef) {
        ...
        this.calciteTipDismiss = core.createEvent(this, "calciteTipDismiss", 7);
    }
    // --------------------------------------------------------------------------
    //
    //  Render Methods
    ...
    // --------------------------------------------------------------------------
    render() {
        return (core.h(core.Host, { dismissed: this.dismissed }, core.h("header", { class: CSS.header }, core.h("h3", { class: CSS.heading }, this.heading), !this.nonDismissible ? (core.h("calcite-action", { text: this.textClose, onClick: this.hideTip, class: CSS.close }, core.h(CalciteIcon.CalciteIcon, { size: "16", path: CalciteIcon.x16 }))) : null), core.h("div", { class: CSS.content }, this.thumbnail ? (core.h("div", { class: CSS.imageFrame }, core.h("img", { src: this.thumbnail, alt: this.textThumbnail }))) : null, core.h("div", { class: CSS.info }, this.el.querySelector("[slot=info]") ? core.h("slot", { name: "info" }) : null, this.el.querySelector("[slot=link]") ? (core.h("p", { class: CSS.link }, core.h("slot", { name: "link" }))) : null))));
    }
...
const CalciteTipManager = class {
    constructor(hostRef) {
        ...
        this.calciteTipManagerClose = core.createEvent(this, "calciteTipManagerClose", 7);
    }
    ...
    render() {
        ...
        return (core.h(core.Host, null, core.h("header", { class: CSS$1.header }, core.h("h2", { class: CSS$1.heading }, this.groupTitle), core.h("calcite-action", { text: this.textClose, onClick: this.hideTipManager, class: CSS$1.close }, core.h(CalciteIcon.CalciteIcon, { size: "16", path: CalciteIcon.x16 }))), core.h("div", { class: index.classnames(CSS$1.tipContainer, this.direction), key: this.selectedIndex }, core.h("slot", null)), core.h("footer", { class: CSS$1.pagination }, core.h("calcite-action", { text: this.textPrevious, onClick: this.previousClicked, class: CSS$1.pagePrevious }, core.h(CalciteIcon.CalciteIcon, { size: "16", path: CalciteIcon.chevronLeft16 })), core.h("span", { class: CSS$1.pagePosition }, `${this.textPaginationLabel} ${this.selectedIndex + 1}/${this.total}`), core.h("calcite-action", { text: this.textNext, onClick: this.nextClicked, class: CSS$1.pageNext }, core.h(CalciteIcon.CalciteIcon, { size: "16", path: CalciteIcon.chevronRight16 })))));
    }
    get el() { return core.getElement(this); }
