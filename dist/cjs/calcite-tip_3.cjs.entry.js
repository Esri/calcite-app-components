...
const CalciteIcon = require('./CalciteIcon-9a7b8782.js');
...
const CalciteTipManager = class {
    ...
    render() {
        ...
        return (core.h(core.Host, null, core.h("header", { class: CSS$1.header }, core.h("h2", { class: CSS$1.heading }, this.groupTitle), core.h("calcite-action", { onClick: this.hideTipManager, class: CSS$1.close }, core.h(CalciteIcon.CalciteIcon, { size: "16", path: index.x16 }))), core.h("div", { class: index$1.classnames(CSS$1.tipContainer, this.direction), key: this.selectedIndex }, core.h("slot", null)), core.h("footer", { class: CSS$1.pagination }, core.h("calcite-action", { onClick: this.previousClicked, class: CSS$1.pagePrevious }, core.h(CalciteIcon.CalciteIcon, { size: "16", path: index.chevronLeft16 })), core.h("span", { class: CSS$1.pagePosition }, `${this.textPaginationLabel} ${this.selectedIndex + 1}/${this.total}`), core.h("calcite-action", { onClick: this.nextClicked, class: CSS$1.pageNext }, core.h(CalciteIcon.CalciteIcon, { size: "16", path: index.chevronRight16 })))));
    }
    get el() { return core.getElement(this); }
