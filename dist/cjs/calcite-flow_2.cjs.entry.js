    ...
    render() {
        ...
        const flowDirectionClass = flowDirection === "advancing"
            ...
            : flowDirection === "retreating"
                ? CSS.frameRetreating
                : "";
        return (core.h(core.Host, null, core.h("div", { key: flowCount, class: `${CSS.frame} ${flowDirectionClass}` }, core.h("slot", null))));
    }
...
const CalciteFlowItem = class {
    constructor(hostRef) {
        ...
        this.calciteFlowItemBackClick = core.createEvent(this, "calciteFlowItemBackClick", 7);
    }
    // --------------------------------------------------------------------------
    //
    //  Render Methods
    ...
    renderBackButton(rtl) {
        ...
        const path = rtl ? CalciteIcon.chevronRight16 : CalciteIcon.chevronLeft16;
        return showBackButton ? (core.h("calcite-action", { key: "back-button", "aria-label": textBack, text: textBack, class: CSS$1.backButton, onClick: this.backButtonClick }, core.h(CalciteIcon.CalciteIcon, { size: "16", path: path }))) : null;
    }
    renderMenuButton() {
        const { menuOpen, textOpen, textClose } = this;
        const menuLabel = menuOpen ? textClose : textOpen;
        return (core.h("calcite-action", { class: CSS$1.menuButton, "aria-label": menuLabel, text: menuLabel, onClick: this.toggleMenuOpen }, core.h(CalciteIcon.CalciteIcon, { size: "16", path: CalciteIcon.ellipsis16 })));
    }
    renderMenuActions() {
        const { menuOpen } = this;
        return (core.h("div", { class: index.classnames(CSS$1.menu, { [CSS$1.menuOpen]: menuOpen }) }, core.h("slot", { name: "menu-actions" })));
    }
    renderFooterActions() {
        const hasFooterActions = !!this.el.querySelector("[slot=footer-actions]");
        return hasFooterActions ? (core.h("footer", { class: CSS$1.footer }, core.h("slot", { name: "footer-actions" }))) : null;
    }
    renderSingleActionContainer() {
        return (core.h("div", { class: CSS$1.singleActionContainer }, core.h("slot", { name: "menu-actions" })));
    }
    renderMenuActionsContainer() {
        return (core.h("div", { class: CSS$1.menuContainer }, this.renderMenuButton(), this.renderMenuActions()));
    }
    renderHeaderActions() {
