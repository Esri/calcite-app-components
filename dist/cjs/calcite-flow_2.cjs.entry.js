...
const __chunk_5 = require('./chunk-c5330c81.js');
...
class CalciteFlowItem {
    ...
    renderBackButton() {
        ...
        return showBackButton ? (__chunk_1.h("calcite-action", { key: "back-button", "aria-label": textBack, text: textBack, class: CSS$1.backButton, onClick: this.backButtonClick }, __chunk_1.h(__chunk_3.CalciteIcon, { size: "16", path: __chunk_2.chevronLeft16 }))) : null;
    }
    renderMenuButton() {
        const { menuOpen, textOpen, textClose } = this;
        const menuLabel = menuOpen ? textClose : textOpen;
        return (__chunk_1.h("calcite-action", { class: CSS$1.menuButton, "aria-label": menuLabel, text: menuLabel, onClick: this.toggleMenuOpen }, __chunk_1.h(__chunk_3.CalciteIcon, { size: "16", path: __chunk_2.ellipsis16 })));
    }
    renderMenuActions() {
        const { menuOpen } = this;
        return (__chunk_1.h("div", { class: __chunk_5.classnames(CSS$1.menu, { [CSS$1.menuOpen]: menuOpen }) }, __chunk_1.h("slot", { name: "menu-actions" })));
    }
    renderFooterActions() {
    ...
    render() {
        ...
        const headerNode = (__chunk_1.h("header", { class: CSS$1.header }, this.renderBackButton(), __chunk_1.h("h2", { class: __chunk_5.classnames(headingClasses) }, this.heading), this.renderHeaderActions()));
