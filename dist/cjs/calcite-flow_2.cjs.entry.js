...
const CalciteFlowItem = class {
    ...
    renderBackButton() {
        ...
        return showBackButton ? (core.h("calcite-action", { key: "back-button", "aria-label": textBack, text: textBack, class: CSS$1.backButton, onClick: this.backButtonClick }, core.h(CalciteIcon.CalciteIcon, { size: "16", path: CalciteIcon.chevronLeft16 }))) : null;
    }
    renderMenuButton() {
    ...
    render() {
        ...
        const headerNode = (core.h("header", { class: CSS$1.header }, this.renderBackButton(), core.h("h2", { class: index.classnames(headingClasses) }, this.heading), this.renderHeaderActions()));
        const contentContainerNode = (core.h("section", { class: CSS$1.contentContainer }, core.h("slot", null)));
        return (core.h(core.Host, null, core.h("article", { class: CSS$1.container }, headerNode, contentContainerNode, this.renderFooterActions())));
    }
    get el() { return core.getElement(this); }
