...
const CalciteFlowItem = class {
    ...
    renderBackButton() {
        ...
        return showBackButton ? (core.h("calcite-action", { key: "back-button", "aria-label": textBack, text: textBack, class: CSS$1.backButton, onClick: this.backButtonClick }, core.h(CalciteIcon.CalciteIcon, { size: "16", path: index.chevronLeft16 }))) : null;
    }
    renderMenuButton() {
        const { menuOpen, textOpen, textClose } = this;
        const menuLabel = menuOpen ? textClose : textOpen;
        return (core.h("calcite-action", { class: CSS$1.menuButton, "aria-label": menuLabel, text: menuLabel, onClick: this.toggleMenuOpen }, core.h(CalciteIcon.CalciteIcon, { size: "16", path: index.ellipsis16 })));
    }
    renderMenuActions() {
        const { menuOpen } = this;
        return (core.h("div", { class: index$1.classnames(CSS$1.menu, { [CSS$1.menuOpen]: menuOpen }) }, core.h("slot", { name: "menu-actions" })));
    }
    renderFooterActions() {
    ...
    render() {
        ...
        const headerNode = (core.h("header", { class: CSS$1.header }, this.renderBackButton(), core.h("h2", { class: index$1.classnames(headingClasses) }, this.heading), this.renderHeaderActions()));
