    ...
    render() {
        ...
        const flowDirectionClass = flowDirection === "advancing"
            ...
            : flowDirection === "retreating"
                ? CSS.frameRetreating
                : "";
        return (__chunk_1.h(__chunk_1.Host, null, __chunk_1.h("div", { key: flowCount, class: `${CSS.frame} ${flowDirectionClass}` }, __chunk_1.h("slot", null))));
    }
...
class CalciteFlowItem {
    constructor(hostRef) {
        ...
        this.calciteFlowItemBackClick = __chunk_1.createEvent(this, "calciteFlowItemBackClick", 7);
    }
    // --------------------------------------------------------------------------
    //
    //  Render Methods
    ...
    renderBackButton() {
        ...
        return showBackButton ? (__chunk_1.h("calcite-action", { key: "back-button", "aria-label": textBack, text: textBack, class: CSS$1.backButton, onClick: this.backButtonClick }, __chunk_1.h(__chunk_4.CalciteIcon, { size: "16", path: __chunk_2.chevronLeft16 }))) : null;
    }
    renderMenuButton() {
        const { menuOpen, textOpen, textClose } = this;
        const menuLabel = menuOpen ? textClose : textOpen;
        return (__chunk_1.h("calcite-action", { class: CSS$1.menuButton, "aria-label": menuLabel, text: menuLabel, onClick: this.toggleMenuOpen }, __chunk_1.h(__chunk_4.CalciteIcon, { size: "16", path: __chunk_2.ellipsis16 })));
    }
    renderMenuActions() {
        const { menuOpen } = this;
        return menuOpen ? (__chunk_1.h("div", { class: CSS$1.menu }, __chunk_1.h("slot", { name: "menu-actions" }))) : null;
    }
    renderFooterActions() {
        const hasFooterActions = !!this.el.querySelector("[slot=footer-actions]");
        return hasFooterActions ? (__chunk_1.h("footer", { class: CSS$1.footer }, __chunk_1.h("slot", { name: "footer-actions" }))) : null;
    }
    renderSingleActionContainer() {
        return (__chunk_1.h("div", { class: CSS$1.singleActionContainer }, __chunk_1.h("slot", { name: "menu-actions" })));
    }
    renderMenuActionsContainer() {
        return (__chunk_1.h("div", { class: CSS$1.menuContainer }, this.renderMenuButton(), this.renderMenuActions()));
    }
    renderHeaderActions() {
