...
var CalciteAction = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        var _a;
        var _b = this, compact = _b.compact, disabled = _b.disabled, el = _b.el, textEnabled = _b.textEnabled, label = _b.label, text = _b.text;
...
var CalciteActionPad = /** @class */ (function () {
    ...
    class_4.prototype.render = function () {
        var _a;
        var _b = this, el = _b.el, offsetTop = _b.offsetTop;
        var style = {
            top: offsetTop + "px"
        };
        var rtl = getElementDir(el) === "rtl";
        ...
        return (h(Host, null, h("div", { style: style, class: classnames(CSS$2.container, (_a = {},
                _a[CSS_UTILITY.rtl] = rtl,
                _a[CSS$2.containerLeading] = layout === "leading",
                _a[CSS$2.containerTrailing] = layout === "trailing",
                _a)) }, h("slot", null))));
    };
    // --------------------------------------------------------------------------
    //
