...
import { c as chevronUp16, a as chevronDown16, C as CalciteIcon, b as caretDown16F, d as caretLeft16F, e as caretRight16F } from './CalciteIcon-389b229f.js';
...
var CalciteBlockSection = /** @class */ (function () {
    ...
    class_2.prototype.render = function () {
        var _a = this, el = _a.el, open = _a.open, textCollapse = _a.textCollapse, textExpand = _a.textExpand;
        var dir = getElementDir(el);
        var arrowIcon = open ? caretDown16F : dir === "rtl" ? caretLeft16F : caretRight16F;
        var toggleLabel = open ? textCollapse : textExpand;
        var headerNode = (h("calcite-action", { "aria-label": toggleLabel, onClick: this.onHeaderClick, text: this.text, "text-enabled": true, compact: true }, h(CalciteIcon, { size: "16", path: arrowIcon })));
