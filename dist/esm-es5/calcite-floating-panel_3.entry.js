...
import { x as x16 } from './index-e4f34f18.js';
...
var CalciteFloatingPanel = /** @class */ (function () {
    ...
    //
    // --------------------------------------------------------------------------
    class_1.prototype.placementHandler = function (newValue) {
    ...
    class_1.prototype.positionElementHandler = function (newValue) {
        this.offsetTop = getOffsetTop({
            floatingElement: this.el,
...
var CalciteShell = /** @class */ (function () {
    ...
    class_2.prototype.renderFooter = function () {
        ...
        return hasFooter ? (h("div", { class: CSS$1.footer }, h("slot", { name: "shell-footer" }))) : null;
    };
    class_2.prototype.renderMain = function () {
        return (h("div", { class: CSS$1.main }, h("slot", { name: "primary-panel" }), this.renderContent(), h("slot", { name: "contextual-panel" }), h("slot", { name: "tip-manager" })));
    };
...
var CalciteShellPanel = /** @class */ (function () {
    ...
    class_3.prototype.render = function () {
        ...
        var contentNode = (h("div", { class: CSS$2.content }, h("slot", null)));
        var actionBarNode = h("slot", { name: "action-bar" });
        var mainNodes = [actionBarNode, contentNode];
        if (layout === "trailing") {
            mainNodes.reverse();
        }
        return (h(Host, null, mainNodes, h("slot", { name: "floating-panel" }), h("slot", { name: "action-pad" })));
    };
...
export { CalciteFloatingPanel as calcite_floating_panel, CalciteShell as calcite_shell, CalciteShellPanel as calcite_shell_panel };
