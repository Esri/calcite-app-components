...
import { C as CalciteIcon, f as ellipsis16, g as chevronRight16, i as chevronLeft16 } from './CalciteIcon-389b229f.js';
...
var CalciteFlowItem = /** @class */ (function () {
    ...
    //
    // --------------------------------------------------------------------------
    class_2.prototype.renderBackButton = function (rtl) {
        var _a = this, showBackButton = _a.showBackButton, textBack = _a.textBack;
        var path = rtl ? chevronRight16 : chevronLeft16;
        return showBackButton ? (h("calcite-action", { key: "back-button", "aria-label": textBack, text: textBack, class: CSS$1.backButton, onClick: this.backButtonClick }, h(CalciteIcon, { size: "16", path: path }))) : null;
    };
    ...
    class_2.prototype.render = function () {
        var _a, _b;
        var _c = this, el = _c.el, showBackButton = _c.showBackButton, heading = _c.heading;
        var rtl = getElementDir(el) === "rtl";
        var headingClasses = (_a = {},
            _a[CSS$1.heading] = true,
            _a[CSS$1.headingFirst] = !showBackButton,
            _a);
        var headerNode = (h("header", { class: CSS$1.header }, this.renderBackButton(rtl), h("h2", { class: classnames(headingClasses) }, heading), this.renderHeaderActions()));
        var contentContainerNode = (h("section", { class: CSS$1.contentContainer }, h("slot", null)));
        return (h(Host, null, h("article", { class: classnames(CSS$1.container, (_b = {},
                _b[CSS_UTILITY.rtl] = rtl,
                _b)) }, headerNode, contentContainerNode, this.renderFooterActions())));
    };
