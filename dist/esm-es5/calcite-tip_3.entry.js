...
import { r as registerInstance, c as createEvent, h, H as Host, g as getElement } from './core-3758c572.js';
import { x as x16, C as CalciteIcon, g as chevronRight16, i as chevronLeft16 } from './CalciteIcon-389b229f.js';
...
var CalciteTip = /** @class */ (function () {
    function class_1(hostRef) {
        ...
        this.hideTip = function () {
            ...
            var storageId = _this.storageId;
            if (storageId) {
                setItem(_this.el.tagName.toLowerCase() + "-" + storageId, "dismissed");
            }
    ...
    class_1.prototype.render = function () {
        return (h(Host, { dismissed: this.dismissed }, h("header", { class: CSS.header }, h("h3", { class: CSS.heading }, this.heading), !this.nonDismissible ? (h("calcite-action", { text: this.textClose, onClick: this.hideTip, class: CSS.close }, h(CalciteIcon, { size: "16", path: x16 }))) : null), h("div", { class: CSS.content }, this.thumbnail ? (h("div", { class: CSS.imageFrame }, h("img", { src: this.thumbnail, alt: this.textThumbnail }))) : null, h("div", { class: CSS.info }, this.el.querySelector("[slot=info]") ? h("slot", { name: "info" }) : null, this.el.querySelector("[slot=link]") ? (h("p", { class: CSS.link }, h("slot", { name: "link" }))) : null))));
    };
...
var CalciteTipManager = /** @class */ (function () {
    function class_3(hostRef) {
        ...
        this.hideTipManager = function () {
            ...
            _this.el.setAttribute("aria-hidden", "");
            _this.calciteTipManagerClose.emit();
        };
    ...
    class_3.prototype.selectedChangeHandler = function () {
    ...
    //
    // --------------------------------------------------------------------------
    class_3.prototype.nextTip = function () {
    ...
    class_3.prototype.previousTip = function () {
        return __awaiter(this, void 0, void 0, function () {
            var previousIndex;
            return __generator(this, function (_a) {
    ...
    //
    // --------------------------------------------------------------------------
    class_3.prototype.setUpTips = function () {
    ...
    class_3.prototype.showSelectedTip = function () {
        var _this = this;
    ...
    class_3.prototype.updateGroupTitle = function () {
    ...
    class_3.prototype.render = function () {
        ...
        return (h(Host, null, h("header", { class: CSS$1.header }, h("h2", { class: CSS$1.heading }, this.groupTitle), h("calcite-action", { text: this.textClose, onClick: this.hideTipManager, class: CSS$1.close }, h(CalciteIcon, { size: "16", path: x16 }))), h("div", { class: classnames(CSS$1.tipContainer, this.direction), key: this.selectedIndex }, h("slot", null)), h("footer", { class: CSS$1.pagination }, h("calcite-action", { text: this.textPrevious, onClick: this.previousClicked, class: CSS$1.pagePrevious }, h(CalciteIcon, { size: "16", path: chevronLeft16 })), h("span", { class: CSS$1.pagePosition }, this.textPaginationLabel + " " + (this.selectedIndex + 1) + "/" + this.total), h("calcite-action", { text: this.textNext, onClick: this.nextClicked, class: CSS$1.pageNext }, h(CalciteIcon, { size: "16", path: chevronRight16 })))));
    };
