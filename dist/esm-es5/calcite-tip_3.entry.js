...
var CalciteTipManager = /** @class */ (function () {
    ...
    class_3.prototype.render = function () {
        ...
        return (h(Host, null, h("header", { class: CSS$1.header }, h("h2", { class: CSS$1.heading }, this.groupTitle), h("calcite-action", { onClick: this.hideTipManager, class: CSS$1.close }, h(CalciteIcon, { size: "16", path: x16 }))), h("div", { class: classnames(CSS$1.tipContainer, this.direction), key: this.selectedIndex }, h("slot", null)), h("footer", { class: CSS$1.pagination }, h("calcite-action", { onClick: this.previousClicked, class: CSS$1.pagePrevious }, h(CalciteIcon, { size: "16", path: chevronLeft16 })), h("span", { class: CSS$1.pagePosition }, this.textPaginationLabel + " " + (this.selectedIndex + 1) + "/" + this.total), h("calcite-action", { onClick: this.nextClicked, class: CSS$1.pageNext }, h(CalciteIcon, { size: "16", path: chevronRight16 })))));
    };
