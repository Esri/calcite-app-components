...
import { x as x16 } from './chunk-e4f34f18.js';
...
class CalciteShell {
    ...
    renderMain() {
        return (h("main", { class: CSS$1.main }, h("slot", { name: "primary-panel" }), this.renderContent(), h("slot", { name: "contextual-panel" }), h("slot", { name: "tip-manager" })));
    }
    render() {
