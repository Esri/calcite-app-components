...
const CalciteFlowItem = class {
    ...
    render() {
        ...
        const headerNode = (h("header", { class: CSS$1.header }, this.renderBackButton(rtl), h("h2", { class: classnames(headingClasses) }, heading), this.renderHeaderActions()));
        const contentContainerNode = (h("section", { class: CSS$1.contentContainer }, h("slot", null)));
        return (h(Host, null, h("article", { class: classnames(CSS$1.container, {
                [CSS_UTILITY.rtl]: rtl
