...
import { r as registerInstance, h, H as Host, g as getElement, c as createEvent } from './chunk-f176fce8.js';
import { c as chevronLeft16, e as ellipsis16 } from './chunk-e4a9dd67.js';
...
var CalciteFlow = /** @class */ (function () {
    ...
    //
    // --------------------------------------------------------------------------
    CalciteFlow.prototype.componentWillLoad = function () {
        this.updateFlowProps();
    };
    CalciteFlow.prototype.componentDidLoad = function () {
        this.flowItemObserver.observe(this.el, { childList: true });
    };
    CalciteFlow.prototype.componentDidUnload = function () {
    ...
    //
    // --------------------------------------------------------------------------
    CalciteFlow.prototype.back = function () {
    ...
    //
    // --------------------------------------------------------------------------
    CalciteFlow.prototype.render = function () {
    ...
    Object.defineProperty(CalciteFlow.prototype, "el", {
        get: function () { return getElement(this); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(CalciteFlow, "style", {
...
var CalciteFlowItem = /** @class */ (function () {
    ...
    //
    // --------------------------------------------------------------------------
    CalciteFlowItem.prototype.renderBackButton = function () {
    ...
    CalciteFlowItem.prototype.renderMenuActions = function () {
        ...
        return menuOpen ? (h("div", { class: CSS$1.menu }, h("slot", { name: "menu-actions" }))) : null;
    };
