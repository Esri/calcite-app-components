...
import { a as chevronsLeft16, b as chevronsRight16 } from './chunk-8490c02a.js';
...
var CalciteAction = /** @class */ (function () {
    function CalciteAction(hostRef) {
    ...
    //
    // --------------------------------------------------------------------------
    CalciteAction.prototype.render = function () {
        var _a;
        var _b = this, textEnabled = _b.textEnabled, label = _b.label, text = _b.text;
        ...
        var compactClass = (_a = {},
            _a[CSS.compact] = this.compact,
            _a);
        return (h(Host, null, h("button", { class: classnames(CSS.button, compactClass), title: labelFallback, "aria-label": labelFallback }, iconContainerNode, textContainerNode)));
    };
    Object.defineProperty(CalciteAction, "style", {
...
var CalciteActionBar = /** @class */ (function () {
    ...
    //
    // --------------------------------------------------------------------------
    CalciteActionBar.prototype.getClosestShellLayout = function () {
    ...
    CalciteActionBar.prototype.renderExpandToggle = function () {
    ...
    CalciteActionBar.prototype.renderBottomActionGroup = function () {
        ...
        return this.el.querySelector("[slot=bottom-actions]") || expandToggleNode ? (h("calcite-action-group", { class: CSS$1.actionGroupBottom }, h("slot", { name: "bottom-actions" }), expandToggleNode)) : null;
    };
    ...
    //
    // --------------------------------------------------------------------------
    CalciteActionBar.prototype.watchHandler = function (newValue) {
        this.el
            .querySelectorAll("calcite-action")
            .forEach(function (action) { return newValue ? action.toggleAttribute("text-enabled") : action.removeAttribute("text-enabled"); });
    };
...
var CalciteActionPad = /** @class */ (function () {
    ...
    //
    // --------------------------------------------------------------------------
    CalciteActionPad.prototype.placementHandler = function (newValue) {
    ...
    CalciteActionPad.prototype.positionElementHandler = function (newValue) {
        this.offsetTop = getOffsetTop({
            floatingElement: this.el,
