(function () {
  ...
  const clientWebSocket = 'WebSocket' in window && new window.WebSocket(getSocketUrl(window.location), ["xmpp"]);
  clientWebSocket && clientWebSocket.addEventListener("message", function (message) {
