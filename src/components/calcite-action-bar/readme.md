...
| `layout`       | `layout`        | <span style="color:red">**[DEPRECATED]**</span> since 5.3 - use "position" instead. Arrangement of the component. Leading and trailing are different depending on if the direction is LTR or RTL. For example, "leading" in a LTR app will appear on the left.<br/><br/> | `"leading" or "trailing"` | `undefined`  |
