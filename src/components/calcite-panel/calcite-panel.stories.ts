...
export const basic = () =>
  create(
    ...
    createAttributes(),
    `${headerHTML}
    <calcite-action text="Action" label="Action" slot="header-leading-content"><calcite-icon icon="bluetooth"></calcite-icon></calcite-action>
    <calcite-action text="Action" label="Action" slot="header-trailing-content"><calcite-icon icon="attachment"></calcite-icon>}</calcite-action>
    ${contentHTML}
    ${footerHTML}`
  );
