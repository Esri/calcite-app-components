...
The `calcite-pick-list` component contains `calcite-pick-list-items` stacked in a panel that can be selected or deselected via shift click to be shown on the view.
