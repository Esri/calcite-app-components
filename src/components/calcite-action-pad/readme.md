...
| `layout`       | `layout`        | <span style="color:red">**[DEPRECATED]**</span> since 5.3.0 - use "position" instead. Arrangement of the component.<br/><br/>                                             | `"leading" or "trailing"` | `undefined` |
| `position`     | `position`      | Arranges the component depending on the elements 'dir' property.                                                                                                          | `"end" or "start"`        | `undefined` |
| `textCollapse` | `text-collapse` | <span style="color:red">**[DEPRECATED]**</span> since 5.4.0 - use "intlCollapse" instead.<br/><br/>Updates the label of the collapse icon when the component is expanded. | `string`                  | `undefined` |
| `textExpand`   | `text-expand`   | <span style="color:red">**[DEPRECATED]**</span> since 5.4.0 - use "intlExpand" instead.<br/><br/>Updates the label of the expand icon when the component is not expanded. | `string`                  | `undefined` |
